...
- Manually exercise picker, drag/drop, and paste in the Tauri desktop app using a managed note; verify the inserted relative image Markdown, hidden asset folder, preview rendering, and both paper appearances.
